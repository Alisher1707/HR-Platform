...
--
-- ESLATMA: bu yerda ishlatilgan work_schedules.is_work_day/start_time/
-- end_time ustunlari keyinchalik 030-migratsiyada work_schedule_days
-- jadvaliga ko'chirilib, work_schedules'dan DROP qilingan. Migratsiya
-- runner har chaqirilganda BARCHA faylni qayta ishga tushiradi (bajarilgan
-- migratsiyalarni kuzatib bormaydi), shuning uchun bu blok faqat o'sha
-- ustunlar hali mavjud bo'lgan holatda (ya'ni 030 hali bajarilmagan
-- birinchi ishga tushirishda) ishlaydi — aks holda xavfsiz no-op.
